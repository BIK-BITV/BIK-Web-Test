...
. Prüfen, ob ein `title`-Element (bei längeren Beschreibungen ein `desc-`Element) vorhanden ist 
  und die dort hinterlegte Textalternative das Bild in angemessener Weise ersetzt 
