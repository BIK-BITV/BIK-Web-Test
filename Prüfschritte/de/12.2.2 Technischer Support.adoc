...
Barrierefreiheit des Webangebots und Kompatibilität mit assistiven Technologien bereitstellen
können.
Dies soll mindestens die Informationen umfassen, die in der
Dokumentation der Webanwndung erwähnt werden (siehe auch Prüfschritt
...
Zielführend könnte beispielsweise sein, anhand der Informationen aus der
