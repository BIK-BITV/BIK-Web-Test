...
Wenn das Webangebot Videos mit zuschaltbaren bzw. programmatisch ermittelbaren Untertiteln überträgt, gibt es eine Option für die Sprachausgabe der Untertitel. Nicht programmatisch ermittelbar sind Untertitel, die "fest eingebrannt", also Teil der Bildinformation, sind.
