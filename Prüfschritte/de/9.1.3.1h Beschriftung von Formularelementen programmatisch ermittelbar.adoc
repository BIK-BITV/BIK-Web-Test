...
drei Auswahllisten haben eine gemeinsame Beschriftung: Datum.
Die Auswahllisten
...
==== 3.3 Suchfeld mit nachfolgenem Button bzw.
Input

Wenn ein einfaches Suchformular nur aus einem Eingabefeld und einem Button besteht, ist oftmals keine sichtbare Beschriftung notwendig.
...
* Ob die Beschriftungen von Formular-Elementen (auch bei Nutzung von Gruppenüberschriften als Ergänzung der unmittelbaren Beschriftungen) hinreichend aussagekräftig sind, wird in Prüfschritt link:/index.php?a=di&iid=80&s=n[2.4.6a] "Aussagekräftige Überschriften und Beschriftungen" geprüft.
