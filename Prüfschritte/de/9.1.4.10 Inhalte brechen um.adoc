...
. Die _Developer Tools_ rechts angedockt öffnen (etwa über Funktionstaste F12) und die vertikale Abgrenzung zwischen Seiten- und Tool-Bereich ziehen, bis oben rechts im Seiten-Bereich _320px x (Viewporthöhe)_ angezeigt wird. 
. Seite neu laden.
