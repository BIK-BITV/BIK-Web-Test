...
Wenn ein Webangebot Echtzeit-Sprachkommunikation bietet und auch Voice-Mail oder sprachbasierte Auswahlmenüs einsetzt, sollen etwaige Aufgaben auch ohne die Fähigkeit zum Hören und Sprechen durchführbar sein.
...
Der Prüfschritt ist anwendbar, wenn die App Echtzeit-Sprachkommunikation wie Voice-Mail oder interaktive Assistenzsysteme, z.B. für die
sprachbasierte Menüführung bei einer Hotline, einsetzt.
