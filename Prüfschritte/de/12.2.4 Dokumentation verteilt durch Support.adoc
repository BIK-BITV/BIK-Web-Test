...
Wenn durch technischen Support eines Angebots Dokumentation angeboten wird, soll diese
...
* Nicht-Web-Dokument (z.B. ein PDF oder eine Word-Datei), dass Kriterien der EN 301 549 Kapitel 10 erfüllt
