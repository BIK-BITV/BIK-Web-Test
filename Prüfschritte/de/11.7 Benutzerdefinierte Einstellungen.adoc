...
Zur Prüfung sollte wenn möglich der Firefox-Browser genutzt werden, der diese Einstellungsmöglichkeiten bietet. DIn anderen Browsern sind ggf. nicht alle diese Einstellungen zu finden, oder sie sind unwirksam.
...
* Fließtext wird nicht vergrößert dargestellt oder sind nicht mehr lesbar
