...
_Informationen > Elementinformationen einblenden_ aktivieren. Text, der überprüft werden soll, anklicken.
Im eingeblendeten Fenster "Elementinformationen" im Bereich "Text" wird die
jeweilige Schriftgröße in Pixeln angegeben.
* Mit Hilfe des http://www.bitvtest.de/bitv_test/das_testverfahren_im_detail/werkzeugliste.html#cca[
Contrast Analyzers] im Bereich _Vordergrund_ mit der Pipette die
