...
* Online-Transaktionen mit begrenzter Session-Dauer und automatischem
  Ausloggen bei längerer Inaktivität
* das automatische Neu-Laden von Seiten oder die zeitverzögerte Weiterleitung
