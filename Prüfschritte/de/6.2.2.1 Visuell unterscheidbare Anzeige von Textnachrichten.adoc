...
Menschen, die Echtzeit-Textkommunikation nutzen, sollen in der Lage sein, empfangene und gesendete Nachrichten visuell zu unterscheiden. So kpnnen sie leichter Dinge finden, die sie selbst oder die andere gesagt (technisch: geschrieben) haben.
...
Wenn Nachrichten des Senders und des Empfängers nur über die Farbe des Textes unterschieden werden können und der Kontrastunterschied beider Arten von Nachricht unter 3:1 liegt, sind sowohl dieser Prüfschritt als auch Prüfschritt 1.4.1a "Ohne Farbe nutzbar" nicht erfüllt.
