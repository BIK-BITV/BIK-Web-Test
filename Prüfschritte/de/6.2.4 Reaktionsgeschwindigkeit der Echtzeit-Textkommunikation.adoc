...
Wenn das Webangebot Echtzeit-Textkommunikation unterstützt und entsprechende Nutzereingaben entgegennimmt, soll die kleinste Texteinheit (einzelne Zeichen oder Wörter) in maximal 500 Millisekunden abgeschickt werden.
...
von der Anwendung abgeschickt werden. Für Hinweise, wie dies zuverlässig in der Praxis gemessen werden kann,
