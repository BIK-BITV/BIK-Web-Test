...
. Das
  https://bitvtest.de/test-methodik/web/werkzeugliste#c337[Images bookmarklet] 
...
. Über den Dialog _Farben verwalten_ eine helle Textfarbe und eine dunkle Hintergrundfarbe wählen, ggf. auch helle Linkfarben wählen.
