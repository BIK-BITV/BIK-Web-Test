...
wenn diese Einstellungen nicht genutzt werden, sollen die Browsereinstellungen übernommen werden.
...
https://github.com/BIK-BITV/BIK-Web-Test/issues[ein Issue zu diesem Prüfschritt erstellen], um bei der
Entwicklung der Prüfung mitzuwirken.
...
Änderungen der Standard-Schriftart werden zur Zeit weder im Firefox- noch im Chrome-Browser übernommen, sobald über CSS für die zu prüfende Seite eine Schriftart festgelegt worden ist, etwa über font-family auf dem body-Element. Die Wireksamkeit der Änderung der Standard-Schriftart wird deshalb zurzeit nicht geprüft.

Die Schriftart und -Größe muss sich nur in Fließtexten an den Browsereinstellungen richten.
Es wird nicht verlangt, dass Bedienelemente der Webseite dynamische Veränderungen dieser Einstellungen unterstützen, da hier das Layout der Webseite verändert würde.
