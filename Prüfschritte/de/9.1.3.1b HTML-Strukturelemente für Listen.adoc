...
Ein häufiger Fall ist die Verwendung von Teaser-Kacheln, 
die oft Bild, Überschrift, Begleittext und Link bündeln 
...
Wird auf Listenauszeichnung von Kachelgruppen verzichtet, 
