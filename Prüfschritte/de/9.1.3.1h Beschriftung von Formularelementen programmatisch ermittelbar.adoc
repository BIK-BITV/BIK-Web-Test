...
* Wenn Auswahllisten (`select`) voneinander abgesetzte Gruppen von Optionen
  enthalten, sind diese mit `optgroup` ausgezeichnet (mit der Web Developer
  Toolbar > Informationen > Elementinformationen einblenden > Kindelemente
  überprüfen)
