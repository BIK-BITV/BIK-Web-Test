...
Wenn zum Beispiel  eine Web-App HTML-Dateien in PDF konvertiert, sollen nach der Konvertierung sämtliche Überschriftsebenen, Alternativtexte und Tabelleninformationen im Zielformat PDF enthalten sein, die auch in der HTML-Quelle vorhanden sind.

Proprietäre Erweiterungen müssen nicht berücksichtigt werden. Dies könnten spezielle Dateiformatserweiterungen von einzelnen Herstellern sein, die nur von einer begrenzten Anzahl an User-Agents / Anzeigeprogrammen unterstützt werden und dabei nicht offen standardisiert sind.

=== Warum wird das geprüft?

Nutzer, die die Barrierefreiheits-Informationen (Überschriftenauszeichnung, Alternativtexte, Untertitel usw.) benötigen, sollen diese auch im Zielformat nutzen können, sofern die Zielformate die Information grundsätzlich unterstützen.
...
* Die Tabelle A1 verweist auf Abschnitt 5.4 "Preservation of accessibility information during conversion".
