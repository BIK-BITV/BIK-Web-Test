...
und für die kein Verhalten bezüglich Zeiger-Gesten über JavaScript festgelegt wurde, und bei denen die Scrollbalken nicht explizit vom Autor versteckt werden.
