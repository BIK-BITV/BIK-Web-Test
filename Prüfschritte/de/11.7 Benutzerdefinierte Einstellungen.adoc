...
Zur Prüfung sollte wenn möglich der Firefox-Browser genutzt werden, der diese Einstellugsmöglichkeiten bietet.  In anderen Browsern sind ggf. nicht alle dieser Einstellungen zu finden oder sie sind unwirksam.
...
Die Seite wird nach dem Vornehmen von eigenen Farbeinstellungen (z.B. heller Text auf dunklem Hintergrund) richtig dargestellt, Schriften erscheinen nach Vergrößerung der Standard-Schriftgröße in den Browsereinstellungen vergrößert in der jeweils eingestelten Schrifttype.
