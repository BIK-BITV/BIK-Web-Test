...
* https://www.w3.org/WAI/WCAG22/Techniques/general/G183.html[
...
* https://www.w3.org/WAI/WCAG22/Techniques/general/G205.html[
  G205: Including a text cue for colored form control labels]

===== Failures

* https://www.w3.org/WAI/WCAG22/Techniques/failures/F13.html[
  ...
  the image]
* https://www.w3.org/WAI/WCAG22/Techniques/failures/F73.html[
