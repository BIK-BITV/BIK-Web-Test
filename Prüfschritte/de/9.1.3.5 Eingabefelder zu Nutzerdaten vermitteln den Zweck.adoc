...
Zusätzliche Informationen können etwa Bilder bzw.
Icons sein, die über ein
...
eine bestimmte Tastenkombunation drücken.
...
Ein Beispiel dafür sind Ticketbuchungsseiten von
Fluglinien.
