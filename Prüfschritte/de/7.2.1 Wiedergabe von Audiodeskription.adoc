...
Audiodeskription kann alternativ auch aus einer von mehrere Audiospuren ausgewählt und abgespielt werden. 

== Warum wird das geprüft?

Werden Inhalte eines Videos nur über Bilder vermittelt, müssen solche Bildsequenzen für blinde Menschen beschrieben werden, damit sie das Video verstehen können. Hierfür wird das Verfahren der Audiodeskription eingesetzt. Damit Audiodeskription ein- und ausgeschaltet werden kann, muss der eingesetzte Player ein entsprechendes AD-Bedienelement oder die Möglichkeit, eine Tonspur mit Audiodeskription in den Spracheinstellungen zu aktivieren, anbieten.

== Wie wird geprüft?

=== 1. Anwendbarkeit des Prüfschritts

Der Prüfschritt ist anwendbar, wenn auf der Webseite ein Videoplayer eingebunden ist, der aufgezeichnete Videos mit synchroner Bild- und Tonspur abspielt und diese Videos eine Audiodeskription benötigen.
...
Wenn die Zugänglichkeit bereits vor der Produktion von Videos berücksichtigt wird, können die Kosten und der Aufwand für die Entwicklung der Beschreibung  möglicherweise reduziert werden. Bei einigen Arten von Videos (wie z.B. einigen Schulungsvideos) kann die Beschreibung der visuellen Informationen von den Sprechern nahtlos integriert werden. Wenn aus diesem oder anderen Gründen eine zusätzliche Audiodeskripiton nicht nötig ist, sollte das Fehlen eines AD-Buttons am Player nicht negativ bewertet werden.
...
In diesem Prüfschritt geht es darum, dass der Videoplayer Bedienelemente zum Ein- und Ausschalten der Audiobeschreibung anbietet und die Bereitstellung während der Wiedergabe ermöglicht.

In Prüfschritt 9.1.2.5 „Audiodeskription für Videos“ wird hingegen geprüft, ob für Inhalte eines Videos, die nur über Bilder vermittelt werden, eine Audiodeskription vorhanden ist. Es geht also um die inhaltliche Beurteilung.
