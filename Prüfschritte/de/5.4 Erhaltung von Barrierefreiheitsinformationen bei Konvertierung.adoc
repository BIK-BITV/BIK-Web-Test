...
Nutzer, welche die Barrierefreiheits-Informationen (Überschriftenauszeichnung, Alternativtexte, Untertitel usw.) benötigen, sollen diese auch im Zielformat nutzen können, sofern die Zielformate die Information grundsätzlich unterstützen.
