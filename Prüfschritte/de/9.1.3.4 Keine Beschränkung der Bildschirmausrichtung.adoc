...
von Ausklapbereichen oder mittels Links auf andere Seiten angeboten werden.
...
Daher sollten Websites und Anwendungen die Darstellung von Inhalten *nicht* auf
lediglich eine Ausrichtung einschränken.

== Wie wird geprüft?

=== 1. Anwendbarkeit des Prüfschritts

Die Prüfung des Wechsels der Bildschirmausrichtung sollte  immer anwendbar
...
oder betriebssystemseitig festgestellt bzw. arretiert ist.
...
Der Inhalt muss also in beiden Ausrichtungen jeweils
neu geladen werden.
