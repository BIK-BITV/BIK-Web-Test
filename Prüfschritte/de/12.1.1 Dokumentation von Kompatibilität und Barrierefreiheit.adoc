...
Die Dokumentation der Web-App soll die Eigenschaften und Funktionen in  Bezug
...
Alle für die Barrierefreiheit relevanten Informationen zur Web-App sollen
in der Dokumentation aufgelistet und erklärt werden.
Die Dokumentation kann dabei mit der Web-App mitgeliefert werden oder separat
verfügbar sein.
...
Die Web-App soll, wenn möglich, Metadaten für die unterstützten
