= Prüfschritt 12.2.4 Bereitgestellte Dokumentation
...
Wenn durch technischen Support Dokumentation geboten wird, soll diese
mindestens in einem der folgenden Formate barrierefrei bereitgestellt
werden:

* Ein Web-Dokument, das die Kriterien der EN 301 549 Kapitel 9 erfüllt
* Nicht-Web-Dokument (z.B. ein PDF), dass Kriterien der EN 301 549 Kapitel 10 erfüllt
...
Gibt es ein Support-Dienstleistung, die technische Dokumentation zur Nutzung bzw. zum Verständnis der angebotenen Funtionen bereitstellt?
Beispiele wären:
