...
statische Inhalte). Nich anwendbar ist der Prüfschritt auf essenziell wichtige Aktualisierungen von Inhalten, zum Beispiel, wenn die verbleibende Zeit einer Session heruntergezählt wird oder Die Höhe eines Auktionsgebots dynamisch aktualisiert wird.
