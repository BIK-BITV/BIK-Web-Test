...
Web-Apps, die Textkommunikation in Echtzeit unterstützen und mit anderen
Anwendungen mit Echtzeit-Textkommunikation-Funktionalität zusammenarbeiten,
sollen implementationsspezifische Methoden zur Interopabilität von
...
Der Prüfschritt ist anwendbar, wenn die Web-App Textkommunikation in
...
+
  ...
  Dabei unterstützt der gemeinsame Standard eine Methode, über die angezeigt wird, wenn Zeichen verloren gingen
  oder fehlerhaft übertragen wurden.
