...
Im BIK BITV-Test können derzeit nur Dokumentationen auf Basis von
Web-Technologien geprüft werden. Für andere Formate muss ein extra Auftrag
gestellt werden.

Wenn die Dokumentation (auch) im HTML-Format vorliegt, ist dieser Prüfschritt
erfüllt, wenn sämtliche anwendbaren Prüfschritte des Verfahrens mit dem
Ergebnis konform durchlaufen wurden.
