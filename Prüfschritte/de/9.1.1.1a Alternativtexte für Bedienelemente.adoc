...
Im Select _Ausgewählte Farben anstatt Farben der Seite verwenden_ die Option _Immer_ wählen.
...
sind: Prüfen, welches Verfahren verwendet wurde, um diese zu verstecken. Wenn
