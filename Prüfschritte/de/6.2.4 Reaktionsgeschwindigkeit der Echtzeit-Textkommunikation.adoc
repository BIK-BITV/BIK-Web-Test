...
Wenn die Web-App Echtzeit-Textkommunikation unterstützt und entsprechende
...
Der Prüfschritt ist anwendbar, wenn die Web-App Eingaben für Echtzeit-Textkommunikation unterstützt.
Das ist z.B. der Fall, wenn es sich um eine App zur Kommunikation handelt, die
Echtzeit-Textkommunikation unterstützt und in der Benutzerschnittstelle eine entsprechende
Eingabemöglichkeit bereithält.
...
von der App abgeschickt werden. Für Hinweise, wie dies zuverlässig in der Praxis gemessen werden kann,
...
Es sollte eine maximale Verzögerung von 300 Millisekunden für das Abschicken
...
=== Wikipedia-Eintrag für Real-Time Text https://en.wikipedia.org/wiki/Real-time_text
