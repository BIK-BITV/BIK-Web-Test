...
Zur Prüfung sollte wenn möglich der Firefox-Browser genutzt werden, der diese Einstellugsmöglichkeiten bietet.  In anderen Browsern sinf ggf. nicht alle dieser Einstellungen zu finden oder sie sind unwirksam.
