...
. Über den Button Erweitert... für Serif, Sans Serif und Feste Breite duetlich abweichende Schriftarten einstellen und bei der Checkbox "Seiten das Verwenden von eigenen statt der oben gewählten Schriftarten erlauben" den Haken entfernen.
