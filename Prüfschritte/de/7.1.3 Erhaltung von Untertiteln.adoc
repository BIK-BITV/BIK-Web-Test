...
Wenn die Webangebot Videos mit Untertiteln konvertiert oder aufnimmt, Video anschließend in einem konformen Player abspielen:
...
=== Einordnung des Prüfschritts nach EN 301 549 v.3.1.1, Annex A

Die Tabelle A1 verweist auf 7.1.3  Preservation of captioning.
