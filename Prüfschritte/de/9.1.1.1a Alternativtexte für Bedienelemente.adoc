...
. Das
  https://www.bitvtest.de/bitv_test/das_testverfahren_im_detail/werkzeugliste.html#imagesbm[Images bookmarklet] 
  zur Anzeige von Alternativtexten aufrufen und prüfen, ob die Bedienelemente mit äquivalenten
...
. https://www.bitvtest.de/bitv_test/das_testverfahren_im_detail/werkzeugliste.html#firefox[
  Firefox] aufrufen und im Anwendungsmenü den Menüpunkt _Einstellungen_ aufrufen. 
  Den Reiter _Inhalt_ wählen und im Bereich _Schriftarten & Farben_ die Option _Farben..._ wählen.
. Im Bereich _Sprache und Erscheinungsbild / Kontraststeuerung_  die Einstellung _Benutzerdefiniert_ auswählen
. Über Farben verwalten eine helle Textfarbe und eine dunkle Hintergrundfarbe wählen, ggf. auch helle Linkfarben wählen
...
. Seite in
  https://www.bitvtest.de/bitv_test/das_testverfahren_im_detail/werkzeugliste.html#firefox[
  Firefox] aufrufen.
. Über das Anwendungsmenü, Menüpunkt _Einstellungen_ im Bereich _Sprache und Erscheinungsbild / Kontraststeuerung_ 
  die Einstellung _Benutzerdefiniert_ aktivieren. Prüfen, ob grafische Bedienelemente verschwinden.
...
. Mit den Developer Tools des Browsers prüfen, ob mit der
...
(siehe 9.4.1.2 Name, Rolle Wert verfügbar).
