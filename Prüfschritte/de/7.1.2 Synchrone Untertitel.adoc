...
Auch wenn Fehler in der Zeitcodierung der Track-Datei gefunden werden, ist davon auszuegehen, dass der Fehler nicht beim Player liegt. Es ist es jedoch nicht ganz auszuschließen, dass eine nicht vorhandene Synchronität an der Untertitel-Datei *und* am Player liegt.
