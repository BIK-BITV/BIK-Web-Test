...
Neben biometrischer Identifizierung oder Steuerung gibt es mindestens eine nich-biometrische oder biomterische Methode.

==== Nicht erfüllt:

Nutzeridentifizierung oder Steuerung wird nur über eine spezifische biometrische Methode angeboten.
