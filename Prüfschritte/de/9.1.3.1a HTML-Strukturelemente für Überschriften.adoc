...
. Mittels
  ...
  HeadingsMap Browser-Plugin] die Überschriften-Hierarchie anzuzeigen.
. Alternativ über die https://www.bitvtest.de/bitv_test/das_testverfahren_im_detail/werkzeugliste.html#webdeveloper[
