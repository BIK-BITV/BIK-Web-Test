...
Anforderungen der Video-Bedienelemente bezüglich Kontrast, zugänglichem Namen, Tasstaturbedienbarkeit, Fokushervorhebung usw. werden in den entsptechenden Prüfschritten geprüft.
