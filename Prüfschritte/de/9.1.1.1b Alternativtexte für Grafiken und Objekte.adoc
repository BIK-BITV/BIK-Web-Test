...
* Illustrationen, Grafiken oder Diagramme, die eine Aussage vorstellen, verdeutlichen oder
...
https://bitvtest.de/test-methodik/web/werkzeugliste#c337[Images bookmarklet] eingesetzt werden.
...
. Seite in
  ...
  Firefox] aufrufen.
. Über die https://bitvtest.de/test-methodik/web/werkzeugliste#c348[Web Developer Toolbar] Hintergrundbilder über _Images_ > _Hide Background Images_ feststellen, ob Hintergrundbilder eingebunden sind. Alternativ können auch andere Methoden verwendet werden.
...
. Bei Nutzung des Video-Elements kann die Textalternative mittels der ARIA Attribute
...
* http://www.w3.org/TR/WCAG22/#text-alternatives[
...
* http://www.w3.org/TR/WCAG22/#x1-1-1-non-text-content[
...
* https://www.w3.org/WAI/WCAG22/Techniques/html/H46[
...
Das ist in vielen Fällen sinnvoll, 
gerade weil nicht nur für sehbehinderte Menschen eine alternativen Beschreibung oft nützlich ist. 
Eine Möglichkeit ist die Positionierung der Alternative 
in einem gut beschrifteten Ausklappbereich unterhalb des Bildes.
