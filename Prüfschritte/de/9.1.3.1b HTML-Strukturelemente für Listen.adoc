...
Beschreibungslisten (`dl`) repräsentieren eine Liste von Gruppen von Begriffen (spezifiziert mit dem `dt`-Element) 
und Beschreibungen (bereitgestellt durch `dd`-Elemente). 
Typische Anwendungen für Beschreibungslisten sind Glossare oder die Darstellung von Schlüssel/Wert-Paaren.
Ihr Einsatz für andere paarige Informationen wird akzeptiert, auch wenn das Konstrukt von Screenreadern nicht gut unterstützt wird.
...
Bei längeren und eigenständigen Kachel-Inhalten ist auch die Auszeichnung mittels `article`-Element denkbar.
...
* https://www.w3.org/WAI/WCAG22/Techniques/html/H48.html[
  H48: Using ol, ul and dl for lists]
* https://www.w3.org/WAI/WCAG22/Techniques/html/H97.html[
  H97: Grouping related links using the nav element]

===== Client-side Scripting Techniques

* https://www.w3.org/WAI/WCAG22/Techniques/client-side-script/SCR28.html[
  SCR28: Using an expandable and collapsible menu to bypass block of content]

===== Failures

* https://www.w3.org/WAI/WCAG22/Techniques/failures/F2.html[
  ...
  text]
* https://www.w3.org/WAI/WCAG22/Techniques/failures/F43.html[
