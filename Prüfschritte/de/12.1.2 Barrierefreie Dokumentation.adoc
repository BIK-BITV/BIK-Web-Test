...
Die Prüfung erfolgt als Teil der Seitenauswahl oder nicht als Teil der Seitenauswahl. Für die Vorgehensweise ist zu prüfen, ob die Voraussetzungen es erlauben, die Dokumentation nicht in die Seitenauswahl aufzunehmen (siehe "3. Hinweise").
