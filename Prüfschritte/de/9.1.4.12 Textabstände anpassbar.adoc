...
* https://www.w3.org/WAI/WCAG22/Techniques/css/C36.html[
  C36: Allowing for text spacing override]
* https://www.w3.org/WAI/WCAG22/Techniques/css/C35.html[
  C35: Allowing for text spacing without wrapping]

==== Failures

* https://www.w3.org/WAI/WCAG22/Techniques/failures/F104[
