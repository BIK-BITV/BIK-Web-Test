...
Der Screenreader ignoriert das Bild dann komplett, er tut so, als ob es
...
Vorlesen von bedeutungslosen Dateinamen an der Nutzung der Seite gehindert wird.
...
aufrufen.
Alternativ kann auch das https://www.bitvtest.de/bitv_test/das_testverfahren_im_detail/werkzeugliste.html[
...
Seite in http://www.bitvtest.de/bitvtest/das_testverfahren_im_detail/werkzeugliste.html#firefox[
Firefox] aufrufen.
...
Die anderen Teilbilder sollten dann mit leeren ``alt``-Attributen versehen sein.
