...
* Elemente, die unterschiedliche Zustände haben können, sollten immer
  ausreichend kontrastieren. Also zum Beispiel: auch die Hervorhebung des Maus- und 
  Tastaturfokus muss den allgemeinen Grenzwert von 4,5:1 (bei großen Schriften 3,0:1) erfüllen.
