...
* https://www.w3.org/WAI/WCAG22/Techniques/general/G60.html[
  G60: Playing a sound that turns off automatically within three seconds]
* https://www.w3.org/WAI/WCAG22/Techniques/general/G170.html[
  G170: Providing a control near the beginning of the Web page that turns off
  sounds that play automatically]
* https://www.w3.org/WAI/WCAG22/Techniques/general/G171.html[
  G171: Playing sounds only on user request]

==== Failures

* https://www.w3.org/WAI/WCAG22/Techniques/failures/F23.html[
