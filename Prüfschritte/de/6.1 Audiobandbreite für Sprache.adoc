...
garantieren, soll die Web-App beim Kodieren
und Dekodieren von Audio einen Frequenzbereich nutzen, dessen obere Grenze
mindestens bis 7.000 Hz reicht.

Damit die Web-App diesen Prüfschritt besteht, muss sie mindestens
...
Der Prüfschritt ist anwendbar, wenn die Web-App eine
...
beurteilt werden.
Die Sprachqualität muss mindestens der Qualität aktueller
