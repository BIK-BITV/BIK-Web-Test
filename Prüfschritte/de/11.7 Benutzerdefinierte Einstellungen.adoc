...
. Über den Button "Erweitert..." für die Schrifttypen "Serif", "Sans Serif" und "Feste Breite" deutlich abweichende Schriftarten einstellen und bei der Checkbox "Seiten das Verwenden von eigenen statt der oben gewählten Schriftarten erlauben" den Haken entfernen.
...
. Prüfen, ob sich die Einstellungen der Schrift, Schriftgröße und Farben auf die Darstellung der Seite auswirken.

=== 3. Hinweise

* Zur Prüfung sollte wenn möglich der Firefox Browser genutzt werden, der diese Enistellugsmöglichkeiten bietet.  In anderen Browsern sinf ggf, nicht alle dieser Einstellungen zu finden, oder sie werden nicht wirksam.
