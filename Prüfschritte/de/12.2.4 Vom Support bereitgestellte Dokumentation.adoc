...
wird diese in mindestens einem der folgenden Formate barrierefrei
angeboten:
...
Weitere gegebenenfalls nicht barrierefreie Versionen der Dokumentation werden nicht
bewertet.
...
Der Prüfschritt ist anwendbar, wenn Support Services eine technische Dokumentation
...
Für andere Formate (etwa PDF) muss gegenenenfalls ein getrennter Prüfauftrag erteilt
werden, da sich diese Formate im BITV-Test nicht prüfen lassen.

=== 2. Prüfung

Gibt es eine Support-Dienstleistung, die eine technische Dokumentation zur Nutzung
