...
Es müssen also nicht sämtliche Bereiche
...
Hinweis: Für die aufgeführten Prüfungen 2.2 bis 2.4 ist eine Sichtprüfung ausreichend, wenn der Kontrast *sehr deutlich* über 3:1 liegt.
...
Der Kontrast von Schrift, einschließlich der von Schriftgrafiken, wird in Prüfschritt link:/index.php?a=di&iid=86&s=n[1.4.3a] "Kontraste von Texten ausreichend" bewertet.
