...
aufnimmt, bleibt die Audiodeskription nach dem Vorgang erhalten. Sie ist weiterhin 
zuschaltbar und wird synchron zu Bild und Ton dargestellt. Die Prüfschritte 
...
Der Prüfschritt ist anwendbar, wenn das Webangebot Videos mit Audiodeskription
