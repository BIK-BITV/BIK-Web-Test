...
Diese Meldungen sind ebenso wichtig für nicht-visuelle
...
Er ist nicht anwendbar, wenn Meldungen im
...
Der Erfolg kann davon abhängen, ob die
...
Das HTML-Element der Statusmeldung muss mit den zugehörigen Rollen/Eigenschaften vorhanden sein, bevor die Statusnachricht erzeugt, also in das HTML-Element eingefügt wird.
Das Erzeugen des HTML-Elements und der eingefügten Statusnachricht sind zwei getrennte Aktionen.
