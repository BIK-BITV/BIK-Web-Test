...
Für die Prüfpraxis sind weitere Hinweise notwendig, auf GitHub können Sie https://github.com/BIK-BITV/BIK-Web-Test/issues[ein Issue anlegen]
https://github.com/BIK-BITV/BIK-Web-Test/issues
