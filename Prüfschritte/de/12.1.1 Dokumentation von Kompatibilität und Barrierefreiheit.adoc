...
. Nicht negativ bewertet werden sollen sehr übliche und selberklärende Funktionen wie Kontrastschalter, Schalter für Farbschemata, Vergrößerungsfunktionen, Schalter für die Deaktivierung von Bewegung und automatischen Audios. Hier ist in Prüfschritt 9.2.4.6 sowieso eine aussagekräftige Beschriftung verlangt, die die Funktion hinreichend deutlich machen sollte.
