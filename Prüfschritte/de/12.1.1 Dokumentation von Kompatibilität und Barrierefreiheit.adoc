...
Die Webseite soll, wenn möglich, Metadaten für die unterstützten Barrierefreiheitsfunktionen und Kompatibilität maschinenlesbar, in geeigneten Formaten, bereitstellen.
