...
Sind Videos mit synchroner Bild- und Tonspur vorhanden, ist gewährleistet, dass der Videoplayer Untertiel und Ton synchron darstellt. 
...
Der Prüfschritt ist anwendbar, wenn auf der Webseite aufgezeichnete Videos mit synchroner Bild- und Tonspur sowie zuschaltbare Untertiteln (closed captions) vorhanden sind.
...
Inhalte, Qualität und Angemessenheit der Untertitel werden in Prüfschritt 9.1.2.2 geprüft. In diesem Prüfschritt wird geprüft, ob der eingebundene Player grundsätzlich in der Lage ist, Videos mit Untertiteln synchron darzustellen. 
