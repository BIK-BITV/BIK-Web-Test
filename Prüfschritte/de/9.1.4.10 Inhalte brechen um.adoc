...
* https://www.w3.org/WAI/WCAG22/Techniques/css/C32.html[
  C32: Using media queries and grid CSS to reflow columns]
* https://www.w3.org/WAI/WCAG22/Techniques/css/C31.html[
...
* https://www.w3.org/WAI/WCAG22/Techniques/css/C38.html[
  C38: Using CSS width, max-width and flexbox to fit labels and inputs]
* https://www.w3.org/WAI/WCAG22/Techniques/client-side-script/SCR34.html[
  SCR34: Calculating size and position in a way that scales with text size]
* https://www.w3.org/WAI/WCAG22/Techniques/general/G206.html[
...
* https://www.w3.org/WAI/WCAG22/Techniques/failures/F102[
