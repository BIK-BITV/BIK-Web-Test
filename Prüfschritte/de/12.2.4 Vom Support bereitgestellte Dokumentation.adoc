...
Für andere Formate (etwa PDF) muss gegenenenfalls ein getrennter Prüfauftrag erteilt werden, 
...
schickt auf Anfrage ein PDF-Handbuch mit einer vollständige Liste 
