...
* Gegebenenfalls zusätzlich NVDA aktvieren, die Seiteninhalte im Lesemodus des Screenreaders (mit Abwärts-Pfeiltaste) durchlaufen.
...
* Sind Inhalten, die standarmäßig visuell ausgeblendet sind, mit geeigneten Techniken für Screenreader-Nutzende verborgen (etwa Ausklappmenüs oder Dialoge)?
