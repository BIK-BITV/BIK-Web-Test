...
Wenn einer der genannten Einstellungen in den verschiedenen Browsern
...
müssen diese in der zu prüfenden Seite übernommen werden.
...
prüfende Webseite wird erneut geöffnet.
