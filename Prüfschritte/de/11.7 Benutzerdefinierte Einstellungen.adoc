...
Wenn Menschen eigene Einstellungen im System oder im Browser vornehmen, zum Beispiel wei sie größere Schrift oder Kontrasteinstellungen brauchen, sollen diese vom Webangebot wo immer möglich respektiert und übernommen werden.
...
* Wenn einer der genannten Einstellungen in den verschiedenen Browsern nicht zu finden ist und somit vom Nutzer nicht angepasst werden kann, wird
...
* Die Schriftart und -Größe muss sich nur in Fließtexten an den Browsereinstellungen richten. Es wird nicht verlangt, dass Bedienelemente der Webseite dynamische Veränderungen dieser Einstellungen unterstützen, da hier das Layout der Webseite verändert würde.
