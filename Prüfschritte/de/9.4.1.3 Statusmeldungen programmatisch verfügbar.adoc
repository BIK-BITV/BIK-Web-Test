...
Ob die Statusmeldung tatsächlich vom Screenreader ausgegeben wird, kann abhängig von genutztem Browser und Screenreader unterschiedlich ausfallen. Für eine möglichst gute Unterstützung in unterschiedlichen Umgebungen ist zu beachten:
