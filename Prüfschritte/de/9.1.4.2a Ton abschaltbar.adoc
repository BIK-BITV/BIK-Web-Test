...
* Das Kontrollelement "Sound" aufrufen: Windows-Menü _Start > Alle Apps > Windows System > Systemsteuerung (> Kategorie Hardware und Sound) > Sound_. In der Registerkarte "Wiedergabe" die Eigenschaften des Lautsprechers aufrufen und den "Pegel" (in gleichnamiger Registerkarte) anzeigen.
