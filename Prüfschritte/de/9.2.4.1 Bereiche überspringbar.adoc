...
. Das http://www.bitvtest.de/bitvtest/das_testverfahren_im_detail/werkzeugliste.html#gegliedert[
...
. Quelltextanalyse: Prüfen, ob die verschiedenen Seitenbereiche durch die
  ...
  werden.
. Das http://www.bitvtest.de/bitvtest/das_testverfahren_im_detail/werkzeugliste.html[
...
* Mehre wichtige Navigationsbereiche sind mit WAI-ARIA document landmarks oder
