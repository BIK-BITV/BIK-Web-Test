...
Alternative für das Icon. In diesem Fall ist es sinnvoll, das Icon selbst mit einer geeigneten Technik für Screenreader
...
. Seite in
  https://www.bitvtest.de/bitv_test/das_testverfahren_im_detail/werkzeugliste.html#firefox[
  Firefox] aufrufen.
. Bedienelemente, die Icon Fonts nutzen, feststellen. 
