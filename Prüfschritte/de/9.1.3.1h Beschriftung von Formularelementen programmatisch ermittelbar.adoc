...
* https://www.w3.org/WAI/WCAG22/Techniques/general/G162.html[
...
* https://www.w3.org/WAI/WCAG22/Techniques/aria/ARIA1.html[
  ARIA1: Using the aria-describedby property to provide a descriptive label
  for user interface controls]
* https://www.w3.org/WAI/WCAG22/Techniques/aria/ARIA2.html[
