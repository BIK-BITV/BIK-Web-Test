...
Schriftgrafiken, die als Bitmap-Grafik eingebunden werden (z. B. als JPEG, PNG,
...
. Die Seite im https://www.bitvtest.de/bitv_test/das_testverfahren_im_detail/werkzeugliste.html#firefox[Firefox] aufrufen.
...
Die Bereitstellung von Alternativtexten für Schriftgrafiken ist Gegenstand der
Prüfschritte
...
* https://www.w3.org/WAI/WCAG21/Techniques/css/C22.html[
  C22: Using CSS to control visual presentation of text]
* https://www.w3.org/WAI/WCAG21/Techniques/css/C30.html[
...
* https://www.paciellogroup.com/blog/2015/12/does-svg-text-pass-wcag-1-4-5-images-of-text/[
  Does SVG text pass WCAG 1.4.5 (Images of Text)?] (Léonie Watson, The
  Paciello Group blog, Dezember 2015)
