...
mit Barrierefreiheit und Kompatibilität beschäftigt, auf HTML-Basis integriert ist.
Eine Dokumentation, die ausschließlich außerhalb der Webseite bereitgestellt wird,
