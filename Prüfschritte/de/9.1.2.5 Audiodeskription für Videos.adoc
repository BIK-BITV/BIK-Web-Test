...
Dagegen enthalten Spielfilme und Reportagen oft Passagen, in denen wenig gesprochen wird und Inhalte über das Bild vermittelt
werden.
Damit ein blinder Zuschauer den Film verfolgen kann, müssen ihm solche Passagen beschrieben werden.
...
ifndef::env_embedded[]
  <<9.1.2.3 Audiodeskription oder Volltext-Alternative für Videos.adoc#,9.1.2.3
  Audiodeskription oder Volltext-Alternative für Videos>>
endif::env_embedded[] nicht bzw. nicht voll erfüllt.
