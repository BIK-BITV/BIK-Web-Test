...
. Über die
  ...
  https://www.bitvtest.de/bitvtest/das_testverfahren_im_detail/werkzeugliste.html#gegliedert[
  Bookmarklet "Inhalte gegliedert"] aufrufen.
  Alternativ das
  https://www.bitvtest.de/bitvtest/das_testverfahren_im_detail/werkzeugliste.html#headingsmap[
