...
Barrierefreiheits-Informationen im Zielformat übernommen werden, wenn das
...
Nutzer, die die Barrierefreiheits-Informationen (Überschriftenauszeichnung, Alternativtexte, 
...
. Sind vom Format grundsätzlich unterstützte Barrierefreiheits-Informationen nach der Konvertierung im Zielformat
erhalten geblieben? 
