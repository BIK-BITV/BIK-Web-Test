...
* Elemente, die unterschiedliche Zustände haben können, sollten in allen Zuständen ausreichend kontrastieren. So muss auch die Hervorhebung des Maus- und Tastaturfokus das geforderte Kontrastverhältnis von 4,5:1 (bei großen Schriften 3:1)  zum Hintergrund erfüllen. (Es wird damit keine Hervorhebung des Mausfokus verlangt - aber wenn der Mausfokus hervorgehoben ist, muss die Hervorhebung die Kontrastanforderung erfüllen.)
