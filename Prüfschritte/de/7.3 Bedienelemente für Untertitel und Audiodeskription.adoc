...
Wenn 7.3 Bedienelemente für Untertitel und Audiodeskription erfüllt ist, ist 7.1.1 Wiedergabe von Untertiteln und 7.2.1 Wiedergabe von Audiodeskripiton ebenfalls erfüllt.
