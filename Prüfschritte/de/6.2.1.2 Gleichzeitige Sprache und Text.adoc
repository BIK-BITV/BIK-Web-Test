...
Wenn die Web-App Zwei-Wege-Kommunikation und Textkommunikation in Echtzeit
...
Der Prüfschritt ist anwendbar, wenn die Web-App Zwei-Wege-Kommunikation
...
. Web-App öffnen
. prüfen, ob die Web-App Zwei-Wege-Kommunikation und Textkommunikation in
  Echtzeit ermöglicht
