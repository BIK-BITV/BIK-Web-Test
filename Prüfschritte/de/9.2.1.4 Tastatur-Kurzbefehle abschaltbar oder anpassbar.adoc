...
=== Das eingebundene Video regagiert auf Tastaturkurzbefehle über Einzeltasten, z.B: "k" zum Pausieren/Abspielen und "m" zum Stummschalten. Ist dies als Verstoß gegen 2.1.4 "Tastatur-Kurzbefehle abschaltbar oder anpassbar" zu werten?
Die Frage ist in Klärung, ob ein Video als https://www.w3.org/TR/WCAG21/#dfn-user-interface-components[User Interface Component] im Sinne der normativne Anforderung interpretiert werden kann. Es gibt dazu https://github.com/w3c/wcag/issues/1950[eine längere Diskussion in dem Github-Issue der Accessibility Guidelines Working Group]. Solange diese Frage nicht klar entschieden ist, sollten Tastaturkutuzbefehle auf fokussierten Videos nicht als Fehler bewertet werden.
