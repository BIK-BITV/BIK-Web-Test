...
* https://www.w3.org/WAI/WCAG22/Techniques/general/G143.html[
  G143: Providing a text alternative that describes the purpose of the CAPTCHA]
* https://www.w3.org/WAI/WCAG22/Techniques/general/G144.html[
...
* https://www.w3.org/WAI/WCAG22/Techniques/failures/F69[
