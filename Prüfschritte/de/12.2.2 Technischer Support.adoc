...
Der Prüfschritt ist anwendbar wenn die Dokumentation des Web-Angebots Hinweise auf Zugänglichkeits-FUnktionen oder Kompatibilität mit Hilfsmtteln enthält.
