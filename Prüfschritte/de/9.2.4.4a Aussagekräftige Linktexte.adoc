...
* Das `title`-Attribut eines Links wird in manchen Fällen nicht von Screenreadern ausgewertet. Es ist gemäß Spezifikation für zusätzliche Informationen gedacht.
...
Bei verlinkten Grafiken ist der Linktext der `alt`-Text des `img`-Elements. Die Aussagekraft des `alt`-Textes wird jedoch geprüft in:
