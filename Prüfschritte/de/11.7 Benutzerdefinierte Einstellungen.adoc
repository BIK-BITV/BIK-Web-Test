...
. Prüfen, ob sich die Einstellungen der Schrifttype, Schriftgröße und Vorder- bzw. Hintergrund-Farben auf die Darstellung der Seite auswirken.
...
* Die Seite wird im Firefox-Browser  nach dem Vornehmen von eigenen Farbeinstellungen (z.B. heller Text auf dunklem Hintergrund) richtig dargestellt, Schriften erscheinen nach Vergrößerung der Standard-Schriftgröße in den Browsereinstellungen vergrößert in der jeweils eingestelten Schrifttype.
