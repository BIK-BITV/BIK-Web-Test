...
Die Synchronität (bzw. das Auftreten von Asynchronität, Ton und Bild laufen nicht gleichzeitig) kann mit einem Testvideoanruf geprüft werden. Dafür muss die App ggf. auf zwei Testgeräten installiert werden.
